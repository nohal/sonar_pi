 ...
 * Author:   Nicholas J. Koch
 ******************************************************************************
 * This file is part of the Sonar plugin
 *
...
#define PLUGIN_NAMESPACE SonarPlugin
...
#define M_LOG_SETTINGS Sonar::LogLevel()
...
#define _PERF_START clock_gettime(CLOCK_MONOTONIC_RAW, &begin);
#define _PERF_END                                                              \
...
#define MODE_SERIAL "tty"
#define MODE_NET    "ip"


#define ID_DBT      0
#define ID_DBT_STR  "DBT"
#define ID_DPT      1
#define ID_DPT_STR  "DPT"
#define ID_NMEA     "EC"

#define kn2ms(x)    (0.51444444444 * (x))
#define m2ft(x)     (3.28084 * (x))
